        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="overview">
            ...
            <AccordionContent className="text-base space-y-3">
              ...
              <p>
                You can create different groups for various projects or contexts, and add tabs, notes, and to-do lists to each group.
              </p>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="getting-started">
            ...
            <AccordionContent className="text-base space-y-3">
              ...
              <ol className="list-decimal pl-6 space-y-2">
                ...
                <li>Fill in the required information and click <strong>"Create"</strong>.</li>
              </ol>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="tabs">
            ...
            <AccordionContent className="text-base space-y-3">
              <p><strong>Creating a Tab:</strong></p>
              <ol className="list-decimal pl-6 space-y-2">
                <li>Click <strong>"Create New"</strong> and select the Tab option.</li>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>You can delete a tab by clicking the delete icon on the tab card.</li>
              </ul>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="notes">
            ...
            <AccordionContent className="text-base space-y-3">
              <p><strong>Creating a Note:</strong></p>
              <ol className="list-decimal pl-6 space-y-2">
                <li>Click <strong>"Create New"</strong> and select the Note option.</li>
                <li>Enter a title for your note.</li>
                <li>Write your note content.</li>
                <li>Select the group where you want to save the note.</li>
                <li>Click <strong>"Create"</strong>.</li>
              </ol>
              <p><strong>Managing Notes:</strong></p>
              <ul className="list-disc pl-6 space-y-2">
                <li>Your notes are displayed as cards in their respective groups.</li>
                <li>You can edit a note by clicking on it.</li>
                <li>Delete a note by clicking the delete icon on the note card.</li>
              </ul>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="todos">
            ...
            <AccordionContent className="text-base space-y-3">
              <p><strong>Creating a Todo List:</strong></p>
              <ol className="list-decimal pl-6 space-y-2">
                <li>Click <strong>"Create New"</strong> and select the Todo option.</li>
                <li>Enter a title for your todo list.</li>
                <li>Select the group where you want to save the todo list.</li>
                <li>Click <strong>"Create"</strong>.</li>
              </ol>
              <p><strong>Managing Todo Lists:</strong></p>
              <ul className="list-disc pl-6 space-y-2">
                <li>After creating a todo list, you can add tasks to it.</li>
                <li>Check off completed tasks by clicking the checkbox.</li>
                <li>Add new tasks using the input field at the bottom of the todo list.</li>
                <li>Delete tasks by clicking the delete icon next to them.</li>
                <li>Delete the entire todo list by clicking the delete icon on the todo list card.</li>
              </ul>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="groups">
            ...
            <AccordionContent className="text-base space-y-3">
              <p>
                Groups help you organize your tabs, notes, and todo lists. Each group is displayed as a column in the workspace.
              </p>
              <p><strong>Using Groups:</strong></p>
              <ul className="list-disc pl-6 space-y-2">
                <li>When creating a new item, you must select which group it belongs to.</li>
                <li>Groups are displayed side by side in a Kanban-style layout.</li>
                <li>Each group can contain a mix of tabs, notes, and todo lists.</li>
              </ul>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="theme">
            ...
            <AccordionContent className="text-base space-y-3">
              ...
              <p>
                To change the theme, click the theme toggle icon in the top right corner of the page and select your preferred option.
              </p>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="tips">
            ...
            <AccordionContent className="text-base space-y-3">
              <ul className="list-disc pl-6 space-y-2">
                <li><strong>Organize by Project:</strong> Create groups for different projects or areas of focus.</li>
                <li><strong>Quick Access:</strong> Save frequently used websites as tabs for quick access.</li>
                <li><strong>Daily Notes:</strong> Create a note for daily tasks or thoughts.</li>
                <li><strong>Track Progress:</strong> Use todo lists to track progress on tasks.</li>
              </ul>
            </AccordionContent>
          </AccordionItem>
        </Accordion>
